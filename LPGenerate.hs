...
generateProblem :: Integer -> Bool -> Int -> Int -> (ParamOpt, ParamCst, BoundsSpace, BoundsCst)
...
generateProblemSF :: Integer -> Int -> Int -> Integer -> Integer -> (ParamOpt, ParamCst, BoundsSpace, BoundsCst)
generateProblemSF gen n m minB maxB = (opt, pcst, bsp, bcst)
  where
...
generateProblemU :: Integer -> Int -> Int -> Integer -> Integer -> (ParamOpt, ParamCst, BoundsSpace, BoundsCst)
generateProblemU gen n m minB maxB = (opt, pcst, bsp, bcst)
  where
  -- Generate parameters of the objective function
